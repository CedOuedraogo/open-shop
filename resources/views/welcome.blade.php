        ...
        <div class="container-fluid">
           <div class="row  justify-content-center align-items-center d-flex text-center h-100">
             <div class="col-12 col-md-8  h-50 ">
                 ...
                 <p class="lead  text-light mb-5">Accedez aux meilleurs prix</p>
        ...
        <div class="container">
           <div class="row">
            ...
            <div class="row">
                   ...
                   <div class="col-md-4">
                       <div class="card text-center mb-4">    <!--b4-card bootstrap -->

                       <img class="card-img-top" src="{{ ($produit->image=='produit.png' OR  $produit->image==null) ? 'https://picsum.photos/1024' : asset('storage/produits/'.$produit->image)}}" alt="">    <!-- pour afficher l'image -->
